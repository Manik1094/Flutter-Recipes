...
class RecipeListScreen extends StatefulWidget {
  ...
  RecipeListScreen({this.listItemIndex});
  @override
...
class _RecipeListScreenState extends State<RecipeListScreen> {
  ...
  _scrollListener(){
    if(_controller.offset >= _controller.position.maxScrollExtent && !_controller.position.outOfRange){
          ...
          print('Reached bottom');
           bloc.fetchRecipesByCategory(
        Constants.DEFAULT_SEARCH_CATEGORIES[widget.listItemIndex] , page + 1);
    }
  }
  ...
  void didChangeDependencies() {
    ...
    bloc.fetchRecipesByCategory(
        Constants.DEFAULT_SEARCH_CATEGORIES[widget.listItemIndex] , page);
  }
        ...
        builder: (BuildContext context,
          ...
          if (snapshot.hasData) {
            ...
            return ListView.builder(
             ...
             return Center(child: Text('Failed to load recipes' , style:TextStyle(color: Colors.black , fontSize: 20.0)),);
          }else{
    ...
    children: <Widget>[
        ...
        Row(
          ...
          children: <Widget>[
               ...
               Text(
                 snapshot.data.recipes[index].social_rank.toString(),
                 style: TextStyle(
                   color: Colors.pink,
                   fontSize: 16.0
                 ),
